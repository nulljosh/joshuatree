...
- [ ] [Sonnet] Paper desktop with a hairline horizon landscape along the bottom, replacing the satellite wallpaper as the default (the map themes stay as options).
