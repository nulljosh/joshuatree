...
PORT = 4451
WALL_W, WALL_H, TILE, ZOOM, COLS, ROWS = 960, 540, 256, 15, 4, 3  # mirror kernel.c's WALL_* constants (WALL_ZOOM 12->14 in v78/0.67.2, 14->15 in v0.76.14 -- keep this in sync by hand, it drifted stale once already)
