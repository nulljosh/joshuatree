...
PORT = 4453
WALL_W, WALL_H, TILE, ZOOM, COLS, ROWS = 960, 540, 256, 16, 4, 3  # mirror kernel.c's WALL_* constants (WALL_ZOOM 14->15 in v0.76.14, 15->16 in v0.76.15 -- keep this in sync by hand, it drifted stale once already)
